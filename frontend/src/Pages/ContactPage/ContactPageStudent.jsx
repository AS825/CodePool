...
`;
    ...
    const mailtoLink = `mailto:alensacipi2@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(
      body
    )}`;
        ...
        <div className='container'>
          <div data-aos='fade-down' className='container-social'>
            <a className='link' href='https://business.codecool.com/de/'>
              <div className='Logo-link animation'>
                <img src={LogoBusiness} alt='codecool' className='CC-Logo-business' />
              </div>
            </a>
          </div>
          <div data-aos='zoom-in' className='img-container'>
            ...
            <div className='contact'>
              <div className='contact-info'>
                ...
                <span className='contact-details'>Business Development Manager</span>
              </div>
          ...
          <form data-aos='fade-left' onSubmit={handleSubmit}>
            <div className='container-text'>
              ...
              {student ? <input type='text' placeholder='Student Name' defaultValue={student.name} /> : null}
              <textarea placeholder='Message' defaultValue={student ? message : null} name='message'></textarea>
